      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full space-y-12 text-left">
        ...
        {(activeModule === 'ALL' || activeModule === 'COMMAND') && (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#0b0e17] border border-purple-500/20 space-y-6">
            ...
            {/* Active Committee Cards or Zero Seeded State */}
            {userChambers.length === 0 ? (
              <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/10 text-center space-y-4">
                ...
                <div className="space-y-1">
                  <h4 className="font-bold text-white text-base">No Seeded / Default Committees</h4>
                  <p className="text-xs text-neutral-400 font-mono max-w-md mx-auto">
                    Committees and chambers are created dynamically by Secretariats and Executive Boards. Launch your custom chamber floor below.
                  </p>
                </div>
                <div className="flex items-center justify-center gap-3">
                  <Link
                    href="/committee"
                    className="px-4 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-mono text-xs font-bold transition flex items-center gap-1.5 shadow-md cursor-pointer"
                  >
                  ...
                  <Link
                    href="/mun/conference"
                    className="px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-neutral-300 font-mono text-xs font-bold transition cursor-pointer"
                  >
