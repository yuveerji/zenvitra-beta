          ...
          return (
            ...
            >
              <div className="space-y-3">
                ...
                {/* Allocation or Waiting Notice */}
                {item.status === 'Allocated' && item.allocatedTo && (
                  <div className="p-2.5 rounded-xl bg-rose-500/10 border border-rose-500/20 text-xs font-mono space-y-0.5">
                    <span className="text-[10px] text-neutral-500 uppercase block">Accredited Delegate:</span>
