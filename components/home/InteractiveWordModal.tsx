...
export const GLOSSARY_TERMS: Record<string, TermDefinition> = {
  ...
  'surveillance-algorithms': {
    ...
    term: 'Algorithmic Noise & Surveillance',
    tag: 'EPISTEMIC DISTORTION',
    icon: Shield,
    definition: 'Attention-harvesting algorithms and engagement-maximizing feed mechanics engineered to reward outrage, polarization, and superficial virality over verified citations and critical thought.',
    platformRelation: 'Zenvitra rejects engagement-driven outrage optimization in favor of chronological feeds, sovereign exploration, and immutable public archives.',
    protocolBadge: 'ANTI-NOISE // SOVEREIGN FEED',
    ctaText: 'Explore Pulse Protocol',
    ctaHref: '/pulse',
    accentColor: 'from-purple-400/20 via-rose-500/10 to-transparent text-purple-300 border-purple-500/30',
    tagColor: 'text-purple-300 border-purple-500/30 bg-purple-500/10',
    dotColor: 'bg-purple-400',
  },
  meritocracy: {
