              ...
              <div className="rounded-[2.5rem] bg-[#07090e] border border-white/15 p-6 sm:p-12 space-y-8 shadow-[0_30px_90px_rgba(0,0,0,0.95)] relative overflow-hidden">
                ...
                {currentStep === 1 && (
                  <div className="space-y-8 animate-in fade-in duration-300">
                    ...
                    {/* One-Click Social Pre-Registration */}
                    <div className="space-y-3 pb-2">
                      <div className="flex items-center justify-between text-xs font-mono text-neutral-400">
                        <span className="uppercase font-semibold text-neutral-300">Fast Track: Pre-fill with OAuth</span>
                        <span className="text-[10px] text-emerald-400 font-bold">Instant Whitelist</span>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button
                          type="button"
                          onClick={() => nextAuthSignIn('google', { callbackUrl: '/statusregister?oauth=success' })}
                          className="py-3 px-4 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 text-white font-mono text-xs flex items-center justify-center gap-2.5 transition cursor-pointer shadow-sm"
                        >
                        ...
                        <button
                          type="button"
                          onClick={() => nextAuthSignIn('github', { callbackUrl: '/statusregister?oauth=success' })}
                          className="py-3 px-4 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 text-white font-mono text-xs flex items-center justify-center gap-2.5 transition cursor-pointer shadow-sm"
                        >
                      ...
                      <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase font-mono">
                          <span className="bg-[#090c13] px-3 text-neutral-400">or enter details manually</span>
                        </div>
                      </div>
                    </div>
