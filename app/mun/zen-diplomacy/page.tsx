...
export const metadata: Metadata = {
  ...
  description: 'Official Online Model United Nations convening on October 24th & 25th, 2026. Featuring AIPPM, Education Ministry of India, UNESCO, and UNSC. Organized by Yuveer.',
  openGraph: {
