...
export const metadata: Metadata = {
  ...
  description: 'Official Online Model United Nations convening on October 24th & 25th, 2026. Featuring AIPPM, Education Ministry of India (EMI), ECOSOC, and UNSC chambers with live resolution drafting on ZEN.DOCS. Organized by Yuveer.',
  openGraph: {
