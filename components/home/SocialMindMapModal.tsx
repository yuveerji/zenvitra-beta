...
export const MAIN_EXTERNAL_PLATFORMS: ExternalPlatformNode[] = [
  ...
  },
  {
    ...
    category: 'DELEGATE & COMMUNITY DISPATCH',
    icon: MessageSquare,
    url: 'https://chat.whatsapp.com/Cmn9ihpEbRs7kLO1G83Fez',
    badgeColor: 'bg-emerald-500/10 text-emerald-300 border-emerald-500/30',
    iconColor: 'text-emerald-400',
    iconBg: 'bg-emerald-500/10 border-emerald-500/20',
    buttonColor: 'bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white',
    lineColor: '#10b981',
    howItConnects: [
      'Official community group announcements & broadcasts',
      'Real-time summit attendee coordination',
      'Live caucus discussion & delegate updates',
    ],
  },
  {
    id: 'twitter',
...
export const SECONDARY_CHANNELS = [
  {
    ...
    handle: 'discord.gg/zenvitra',
    icon: MessageSquare,
    url: 'https://discord.gg/zenvitra',
    badge: 'LIVE CAUCUS',
    badgeColor: 'bg-indigo-500/10 text-indigo-300 border-indigo-500/30',
    iconColor: 'text-indigo-400',
    iconBg: 'bg-indigo-500/10 border-indigo-500/20',
    tag: 'Real-time voice discussions & builder hackathons',
  },
  {
    name: 'Telegram Wire',
    ...
    iconColor: 'text-sky-400',
    iconBg: 'bg-sky-500/10 border-sky-500/20',
    tag: 'Direct announcements & updates',
  },
  {
    name: 'GitHub Core',
